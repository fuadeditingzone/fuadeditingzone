...
export const BehanceIcon = ({ className }: { className?: string }) => (
  <i className={`fa-brands fa-behance ${className || ''}`} />
);

export const TikTokIcon = ({ className }: { className?: string }) => (
  <i className={`fa-brands fa-tiktok ${className || ''}`} />
);
...
export const CrystalStarIcon = ({ className, title }: { className?: string; title?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        {title && <title>{title}</title>}
        <path d="M12 0L14.121 9.879L24 12L14.121 14.121L12 24L9.879 14.121L0 12L9.879 9.879L12 0Z" />
    </svg>
);
...
export const GoogleIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
        ...
        <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.23,4.14-4.082,5.571l6.19,5.238C43.021,36.251,44,30.686,44,24C44,22.659,43.862,21.35,43.611,20.083z"/>
    </svg>
);
...
export const ThumbnailIcon = ({ className }: { className?: string }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 3.75h12A2.25 2.25 0 0120.25 6v12A2.25 2.25 0 0118 20.25H6A2.25 2.25 0 013.75 18V6A2.25 2.25 0 016 3.75zM10.5 8.25v7.5l6-3.75-6-3.75z" />
  </svg>
);
// FIX: Added style prop to allow for inline styling, fixing TypeScript errors in components that use this icon with styles.
export const VfxIcon = ({ className, style }: { className?: string; style?: React.CSSProperties }) => (
    <svg className={className} style={style} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 20.25h12m-7.5-3.75v3.75m-3.75-3.75v3.75m-3.75-3.75v3.75M9 6.75h.008v.008H9V6.75zm3.75 0h.008v.008h-.008V6.75zm3.75 0h.008v.008h-.008V6.75zm-3.75 3h.008v.008h-.008v-.008zm3.75 0h.008v.008h-.008v-.008zm-3.75 3h.008v.008h-.008V12.75zm3.75 0h.008v.008h-.008V12.75zM3.75 6.75h16.5c.621 0 1.125.504 1.125 1.125v10.5c0 .621-.504 1.125-1.125 1.125H3.75c-.621 0-1.125-.504-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125z" />
    </svg>
);
...
export const StreamPackageIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75L2.25 12l4.179 2.25m0-4.5l5.571 3 5.571-3m-11.142 0L2.25 7.5 12 2.25l9.75 5.25-4.179 2.25m0 0L21.75 12l-4.179 2.25m-13.5 0L2.25 12" />
    </svg>
);
export const IntroOutroIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 7.5l3 2.25-3 2.25m4.5 0h3m-9 8.25h13.5A2.25 2.25 0 0021 18V6a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 6v12a2.25 2.25 0 002.25 2.25z" />
    </svg>
);
export const ColorGradingIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const UsersIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.663M12 12.75a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);
...
// Adobe Icons
export const AeIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M9.81 5.32H14.19V6.4H11.52V9.91H14.01V10.99H11.52V14.54H14.21V15.62H9.81V5.32Z" fill="#D59FFF"/>
    <path d="M5.01 15.62L8.23 8.34L5.01 5.32H6.43L8.85 9.7L9.07 10.42H9.11L10.22 5.32H11.56L8.62 12.33L11.58 15.62H10.24L9.12 13.01H9.08L8.82 13.8L6.44 15.62H5.01Z" fill="#D59FFF"/>
  </svg>
);

export const PsIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M9.81 5.32H13.11C14.73 5.32 15.69 6.08 15.69 7.96C15.69 9.01 15.35 9.8 14.63 10.37C13.91 10.94 13.01 11.23 11.9 11.23H11.13V15.62H9.81V5.32ZM11.13 6.4V10.15H11.66C13.21 10.15 14.07 9.4 14.07 7.95C14.07 6.48 13.21 5.72 11.66 5.72H11.13V6.4Z" fill="#31A8FF"/>
    <path d="M14.29 11.72H16.48V15.62H17.81V11.72H18.9V10.66H14.29V11.72Z" fill="#31A8FF"/>
  </svg>
);

export const AiIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M9.81 12.08L5.97 15.62H7.49L8.03 14.47H11.02L11.56 15.62H13.08L9.24 12.08H9.81ZM10.53 13.5H8.52L9.52 11.24L10.53 13.5Z" fill="#FF7C00"/>
    <path d="M15.42 5.32H16.5V15.62H15.42V5.32Z" fill="#FF7C00"/>
  </svg>
);

export const PrIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M9.81 5.32H13.11C14.73 5.32 15.69 6.08 15.69 7.96C15.69 9.01 15.35 9.8 14.63 10.37C13.91 10.94 13.01 11.23 11.9 11.23H11.13V15.62H9.81V5.32ZM11.13 6.4V10.15H11.66C13.21 10.15 14.07 9.4 14.07 7.95C14.07 6.48 13.21 5.72 11.66 5.72H11.13V6.4Z" fill="#D59FFF"/>
    <path d="M14.34 11.03L16.4 15.62H17.81L15.03 9.49H13.84L12.08 13.1H12.04L13.12 11.03H14.34Z" fill="#D59FFF"/>
  </svg>
);

    ...
    <React.StrictMode>
      <ClerkProvider 
        ...
        appearance={{
          ...
          elements: {
            // Dropdown layout for desktop (Top-Right), centered for mobile. No blur.
            modalBackdrop: "bg-black/30 backdrop-blur-none fixed inset-0 flex items-start justify-end p-4 md:p-8 pt-20 md:pt-24 z-[99999]",
            ...
            card: "bg-white shadow-none border-none p-10 md:p-14 mx-auto",
            
            userProfile: {
              root: "w-full bg-white flex flex-col md:flex-row h-full max-h-[85vh] max-w-[850px]",
              navbar: "border-r border-zinc-100 bg-zinc-50/50 p-8 md:w-64 flex-shrink-0",
              navbarButton: "text-zinc-500 font-black uppercase tracking-widest text-[10px] hover:bg-zinc-100 rounded-2xl mb-2 px-5 py-4",
              navbarButton__active: "text-red-600 bg-red-50 hover:bg-red-50 shadow-sm",
              pageScrollBox: "custom-scrollbar flex-1 p-10 md:p-16 overflow-y-auto bg-white",
              headerTitle: "text-zinc-900 font-black uppercase tracking-tight text-3xl mb-3",
              headerSubtitle: "text-zinc-500 text-[11px] uppercase tracking-[0.4em] font-bold mb-10",
              profilePage__common: "bg-white",
              sectionTitleText: "text-zinc-900 font-black uppercase tracking-widest text-[11px] border-b border-zinc-100 pb-5 mb-10",
            },
            
            headerTitle: "text-zinc-900 font-black uppercase tracking-tight text-2xl text-center",
            headerSubtitle: "text-zinc-500 text-[10px] text-center uppercase tracking-widest font-bold mb-6",
            ...
            formButtonPrimary: "bg-red-600 hover:bg-red-700 text-white font-black uppercase tracking-[0.3em] text-[11px] h-14 transition-all shadow-xl active:scale-95 px-8",
            ...
            formFieldLabel: "text-zinc-900 font-black uppercase text-[10px] tracking-widest mb-3 ml-1",
            ...
            userButtonPopoverCard: "bg-white border border-zinc-200 shadow-3xl w-[calc(100vw-2rem)] max-w-[440px] overflow-hidden rounded-[2.5rem]",
            userButtonPopoverActionButtonText: "text-zinc-900 font-black uppercase tracking-widest text-[11px]",
            userButtonPopoverActionButton: "hover:bg-zinc-50 transition-colors py-6 px-10",
            ...
            alert: "bg-red-50 border border-red-100 text-red-700 rounded-2xl text-[11px] font-bold p-6",
